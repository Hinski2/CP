...
void na_cyklu(int a, int b)
{
    ...
    if(max(do_x, b) < max(a, do_y))
    {
        ansx = do_x;
        ansy = b;
    }
    else if(max(do_x, b) == max(a, do_y) && min(do_x, b) < min(a, do_y))
    {
        ansx = do_x;
        ansy = b;
    }
    else if(max(do_x, b) == max(a, do_y) && min(do_x, b) == min(a, do_y) && (b < do_y))
    {
        ansx = do_x;
        ansy = b;
    }
