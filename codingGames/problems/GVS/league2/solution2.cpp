...
namespace gameplay{
    ...
    int choose_best_gift(){
        ...
        for(int i = 0; i < gift::end; i++)
            if(player::gift_intercetpion_time[me][0][i] != never && std::max(1, player::gift_intercetpion_time[me][0][i] * (4 - gift::gift[i].value) / 2) < mini && player::gift_intercetpion_time[me][0][i] <= player::gift_intercetpion_time[foe][0][i])
                mini = std::max(1, player::gift_intercetpion_time[me][0][i] * (4 - gift::gift[i].value) / 2), argmini = i;
